  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-24 min-h-screen">
      <div className="text-center mb-16">
        <h1 className="text-3xl sm:text-5xl font-black mb-6 text-text">About <span className="text-terracotta">Shinerva AI</span></h1>
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-16">
        <div className="bg-surface border border-surface2 p-6 sm:p-8 rounded-3xl">
